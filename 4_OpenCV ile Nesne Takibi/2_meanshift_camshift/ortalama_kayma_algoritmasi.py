...
Ortalama Kayma Algoritması:
    Meanshift(Ortalama Kayma), noktaları moda doğru kaydırarak
    veri noktalarını kümlere yinelemeli olarak atayan
    bir kümeleme algoritmasıdır.
    
    Mod, en yüksek veri noktasıyoğunluğu olarak tanımlanabilir.
    
    Bu nedenle, mod arama algoritması olarakta bilinir.
